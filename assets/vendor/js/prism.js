	...
	var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
		t = self.Prism = {
			...
			highlightAll: function (e, n) {
				for (var a, r = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), i = 0; a = r[i++];) t.highlightElement(a, !0 === e, n)
			},
				...
				e: for (var l in n)
					if (n.hasOwnProperty(l) && n[l]) {
						...
						for (var p = 0; p < i.length; p++) {
							...
							if (!(f instanceof r))
								if (g.lastIndex = 0, h = g.exec(f)) {
									c && (u = h[1].length);
									var h, d = h.index - 1 + u,
										m = d + (h = h[0].slice(u)).length,
										y = f.slice(0, d + 1),
										w = f.slice(m + 1),
										b = [p, 1];
									y && b.push(y);
									var k = new r(l, o ? t.tokenize(h, o) : h);
									b.push(k), w && b.push(w), Array.prototype.splice.apply(i, b)
								}
						}
					}
				return i
